...
// ransec to segment ground
void ransec(const pcl::PointCloud<pcl::PointXYZ>::Ptr pt,pcl::PointCloud<pcl::PointXYZ>::Ptr ground,pcl::PointCloud<pcl::PointXYZ>::Ptr scene){
    float sigma = 0.3;
    size_t num_iter = 100;
